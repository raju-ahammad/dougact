...
const WorksPostUpdate = () => {
    ...
    const blogUpdate = async () => {
        try {
            const res = await axios.put(`/api/works/edit/${id}`, {title, image: workimage, video, description})
            setLoading(true)
    ...
    return (
        <div className="work__post">
            ...
            <div className="work__form">
                ...
                <h2 className="workpost__title">Work Post Update Here</h2>
...
export default WorksPostUpdate
